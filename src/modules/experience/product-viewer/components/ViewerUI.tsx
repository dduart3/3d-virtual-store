...
export const ViewerUI = () => {
  ...
  // Always call all hooks, regardless of loading state
  ...
  // Don't render UI if loading or not open
  if (viewerState.isLoading || !viewerState.isOpen || !product) {
    return null;
  }
  ...
  return (
    <div className="fixed top-0 left-0 w-screen h-screen flex items-center justify-center select-none">
      <div className="relative w-full h-full">
        ...
        {/* Rest of your UI... */}
        {/* Product Name */}
        <h1 className="absolute top-[10%] left-1/2 -translate-x-1/2 text-white text-[2.6rem] font-extralight tracking-[0.2em] m-0 uppercase">
          {product.name}
        </h1>
