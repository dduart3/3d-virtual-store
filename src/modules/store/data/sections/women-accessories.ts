  ...
  products: [
    {
      ...
      price: 1299.99,
      model: {
        path: `products/${STORE_SECTION_IDS.WOMEN_ACCESSORIES}/ring`,
        position: [0, 0.2, 5],
        rotation: [-12, 0, 0],
        scale: 0.3
      },
    },
    {
      ...
      price: 179.99,
      model: {
        path: `products/${STORE_SECTION_IDS.WOMEN_ACCESSORIES}/watch`,
        position: [0, -.4, 6],
        rotation: [0, 0, -.3],
        scale: 0.1
      },
    },
    {
      ...
      price: 899.99,
      model: {
        path: `products/${STORE_SECTION_IDS.WOMEN_ACCESSORIES}/necklace`,
        position: [0, 0.6, 7],
        scale: 0.012
      },
    },
