  ...
  products: [
    {
      ...
      price: 129.99,
      model: {
        path: `products/${STORE_SECTION_IDS.WOMEN_SHOES}/high-heels`,
        position: [0, -0.15, 4.7],
        scale: 0.08,
      },
    },
    {
      ...
      price: 99.99,
      model: {
        path: `products/${STORE_SECTION_IDS.WOMEN_SHOES}/low-heels`,
        position: [0, -0.15, 4.7],
        rotation: [0, 0, -25],
      },
    },
    {
      ...
      price: 149.99,
      model: {
        path: `products/${STORE_SECTION_IDS.WOMEN_SHOES}/boot`,
        position: [0, 0.45, 4.4],
        scale: 0.8,
      },
    },
