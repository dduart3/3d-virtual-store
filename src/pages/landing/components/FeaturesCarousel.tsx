...
export function FeaturesCarousel({ carouselRef, carouselTrackRef }: FeaturesCarouselProps) {
  return (
      <div ref={carouselRef} className="absolute inset-0 z-[70] translate-y-[100px] opacity-0 pointer-events-auto flex flex-col">
         ...
         {/* Carousel Track */}
         <div ref={carouselTrackRef} className="flex gap-4 md:gap-32 pl-4 md:pl-[20vw] items-center h-full relative z-10">
            {[
                ...
                <div key={i} className={`relative flex-shrink-0 bg-gray-900 rounded-lg overflow-hidden shadow-2xl group transition-all duration-500 ${item.wide ? 'w-[85vw] md:w-[70vw]' : 'w-[85vw] md:w-[60vw]'} h-[65vh] md:h-[75vh]`}>
                      ...
                      {/* Content */}
                      <div className="absolute bottom-0 left-0 w-full p-6 md:p-12 flex flex-col items-start translate-y-0 md:translate-y-4 md:group-hover:translate-y-0 transition-transform duration-500">
            ...
            {/* Final CTA Card */}
            <div className="relative flex-shrink-0 bg-gray-900 rounded-lg overflow-hidden shadow-2xl group transition-all duration-500 w-[85vw] md:w-[60vw] h-[65vh] md:h-[75vh] flex items-center justify-center border border-white/10">
